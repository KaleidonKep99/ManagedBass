...
{
    /// <summary>
	/// Used with <see cref="BassMidi.StreamSetFonts(int,MidiFontEx2[],int)" /> and <see cref="BassMidi.StreamGetFonts(int,MidiFontEx2[],int)" /> to set and retrieve soundfont configurations.
	/// </summary>
	/// <remarks>
